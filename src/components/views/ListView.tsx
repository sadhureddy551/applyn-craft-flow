...
export function ListView({ records, fields, onView, onDelete }: ListViewProps) {
      ...
      {records.map((rec, i) => {
        ...
        return (
          <motion.div
            ...
            className="rounded-xl border border-border bg-card p-4 hover:shadow-card-hover transition-all cursor-pointer group"
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {status && (
                    <Badge variant="secondary" className={`text-[10px] px-1.5 py-0 ${statusColors[status] || ''}`}>
                      {status}
                    </Badge>
                  )}
                </div>
              ...
              <div onClick={(e) => e.stopPropagation()}>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem className="text-destructive" onClick={() => onDelete(rec.id, name)}>
