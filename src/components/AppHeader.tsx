import { Search, Bell, Check, X, UserPlus, GitBranch, Zap, FileText, CheckSquare } from 'lucide-react';
    ...
    <header className="h-14 border-b border-border bg-card flex items-center px-4 gap-4 shrink-0">
      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <Input placeholder="Search records, modules..." className="pl-9 h-9 bg-muted/50 border-0 focus-visible:ring-1 focus-visible:ring-ring" />
        </div>
      </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          <button onClick={(e) => { e.stopPropagation(); dismiss(n.id); }} className="h-6 w-6 rounded flex items-center justify-center text-muted-foreground hover:text-destructive hover:bg-muted">
                            <X className="h-3 w-3" />
                          </button>
                        </div>
                      </div>
